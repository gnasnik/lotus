...
type AggregateInput struct {
	...
	Info  miner.AggregateSealVerifyInfo
	Proof []byte
}
...
func (b *CommitBatcher) processBatch(cfg sealiface.Config) ([]sealiface.CommitBatchRes, error) {
	...
	infos := make([]miner.AggregateSealVerifyInfo, 0, total)
	collateral := big.Zero()
	...
	params.AggregateProof, err = b.prover.AggregateSealProofs(miner.AggregateSealVerifyProofAndInfos{
