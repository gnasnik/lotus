...
func (l *LocalWorker) GenerateWinningPoSt(ctx context.Context, ppt abi.RegisteredPoStProof, mid abi.ActorID, sectors []storiface.PostSectorChallenge, randomness abi.PoStRandomness) ([]miner.PoStProof, error) {
	sb, err := l.executor()
	if err != nil {
		return nil, err
	}
