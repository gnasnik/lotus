...
func (sb *Sealer) GenerateWinningPoSt(ctx context.Context, minerID abi.ActorID, sectorInfo []proof.ExtendedSectorInfo, randomness abi.PoStRandomness) ([]miner.PoStProof, error) {
	randomness[31] &= 0x3f
...
func (sb *Sealer) GenerateWindowPoSt(ctx context.Context, minerID abi.ActorID, sectorInfo []proof.ExtendedSectorInfo, randomness abi.PoStRandomness) ([]miner.PoStProof, []abi.SectorID, error) {
	randomness[31] &= 0x3f
...
func (proofVerifier) VerifySeal(info miner.SealVerifyInfo) (bool, error) {
	return ffi.VerifySeal(info)
}

func (proofVerifier) VerifyAggregateSeals(aggregate miner.AggregateSealVerifyProofAndInfos) (bool, error) {
	return ffi.VerifyAggregateSeals(aggregate)
}

func (proofVerifier) VerifyReplicaUpdate(update miner.ReplicaUpdateInfo) (bool, error) {
	return ffi.SectorUpdate.VerifyUpdateProof(update)
}

func (proofVerifier) VerifyWinningPoSt(ctx context.Context, info miner.WinningPoStVerifyInfo) (bool, error) {
...
func (proofVerifier) VerifyWindowPoSt(ctx context.Context, info miner.WindowPoStVerifyInfo) (bool, error) {
	info.Randomness[31] &= 0x3f
